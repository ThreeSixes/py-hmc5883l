A simple Python library to communicate with the Honeywell HMC5883L 3-axis magnetometer. This requires the python-smbus library. It requires that you load the i2c-dev kernel module as well.
